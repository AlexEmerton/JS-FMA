$(document).ready(function () {
	...
	}, "You must enter a correct email address");
	...
	}, 'You must enter a correct last name. More than one character and letters only (single hyphen is allowed)');
	...
	}, 'You must enter a correct first name. More than one character and letters only');
	...
	}, 'You must enter a correct Health Authority Number (e.g. ZHA346783)');
	...
	}, 'You must enter a correct telephone number. 11 digits long');
